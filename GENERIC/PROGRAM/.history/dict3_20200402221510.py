...
max_value = max(a_dictionary.values())     all_values is a list
...
def max_visited_speciality(patient_medical_speciality_list,medical_speciality):
    ...
    for i in medical_speciality:
        s_list[i]=0
    # print(s_list)
    for val in patient_medical_speciality_list.values():
        s_list[val]+=1
    # print(max(s_list,key=s_list.get))
...
medical_speciality={'O': 'Orthopedics', 'P': 'Pediatrics', 'E': 'ENT'}
